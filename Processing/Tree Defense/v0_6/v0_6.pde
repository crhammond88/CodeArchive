...
// enemy vars
int flyingEnemySize = 40;
int numFlyingEnemies = 15;
int flyingEnemyCount = 0;
int flyingEnemyCD = 9000;
int flyingEnemyMaxHP = 50;
float flyingEnemySpeed = 0.2;
int flyingEnemyDamage = 1;
...
int smallEnemySize = 20;
int numSmallEnemies = 10;
int smallEnemySpeed = 2000;
int smallEnemyCD = 5000;
int smallEnemyMaxHP = 100;
int smallEnemyCount = 0;
int smallEnemyDamage = 5;

int largeEnemySize = 100;
int numLargeEnemies = 5;
int largeEnemySpeed = 8000;
int largeEnemyCD = 20000;
int largeEnemyMaxHP = 2000;
int largeEnemyCount = 0;
int largeEnemyDamage = 100;


int [] enemyHealth;
boolean [] enemyExists;
int numTotalEnemies = numEnemies + numFlyingEnemies + numSmallEnemies + numLargeEnemies;
