...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.dir = float(random.randint(0,359))
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        """
        self.room.cleanTileAtPosition(self.pos)
        self.now = self.pos.getNewPosition(self.dir, self.speed)
        if not self.room.isPositionInRoom(self.now):
            self.dir = float(random.randint(0,359))
        else:
            self.pos = self.now
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        self.room.cleanTileAtPosition(self.pos)
        self.now = self.pos.getNewPosition(self.dir, self.speed)
        if self.room.isPositionInRoom(self.now):
            self.pos = self.now
        self.dir = float(random.randint(0,359))
